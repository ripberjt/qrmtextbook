...
```{r iv-dv, echo=FALSE, out.width= "75%", fig.cap="Sample Table Layout"}
...
```{r iv-dv2, echo=FALSE, out.width= "75%", fig.cap="Sample Null-Hypothesized Table Layout as Percentages"}
knitr::include_graphics("iv-dv2.png")
```

```{r iv-dv3, echo=FALSE, out.width= "75%", fig.cap="Sample Null-Hypothesized Table Layout as Counts"}
...
```{r chiscalc, echo=FALSE, out.width= "75%", fig.cap="Chi Square Calculation"}
...
```{r control1, echo=FALSE, out.width= "100%", fig.cap="Controlling for a Third Variable: Nothing Changes"}
knitr::include_graphics("control1.png")
```

```{r control2, echo=FALSE, out.width= "75%", fig.cap="Controlling for a Third Variable: Spurious"}
...
```{r chisquaretable, echo=FALSE, out.width= "100%", fig.cap="Chi Square Table"}
