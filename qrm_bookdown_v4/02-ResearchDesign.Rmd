...
```{r post, echo=FALSE, fig.cap="Post-test Only (with a Control Group) Experimental Design", fig.height=1, fig.width=2}
par(xaxs = 'i', yaxs = 'i', mar = c(1, 1, 1, 1))
plot(NA, xlim = c(1, 3), ylim = c(1, 2), axes = FALSE, ann = FALSE)
text(x = 2, y = 1.8, bquote(paste('R  X  O'['1'])))
text(x = 2, y = 1.2, bquote(paste('R      O'['2'])))
```
...
```{r prepost, echo=FALSE, fig.cap="Pre-test, Post-Test (with a Control Group) Experimental Design", fig.height=1, fig.width=2}
par(xaxs = 'i', yaxs = 'i', mar = c(1, 1, 1, 1))
plot(NA, xlim = c(1, 3), ylim = c(1, 2), axes = FALSE, ann = FALSE)
text(x = 2, y = 1.8, bquote(paste('R  O'['1'], '  X  O'['2'])))
text(x = 2, y = 1.2, bquote(paste('R  O'['3'], '      O'['4'])))
```
...
```{r solomon, echo=FALSE, fig.cap="Solomon Four Group Experimental Design", fig.height=1.3, fig.width=2}
par(xaxs = 'i', yaxs = 'i', mar = c(1, 1, 1, 1))
plot(NA, xlim = c(1, 3), ylim = c(1, 2), axes = FALSE, ann = FALSE)
text(x = 2, y = 1.8, bquote(paste('R         X  O'['1'])))
text(x = 2, y = 1.6, bquote(paste('R             O'['2'])))
text(x = 2, y = 1.4, bquote(paste('R  O'['3 '], '  X  O'['4'])))
text(x = 2, y = 1.2, bquote(paste('R  O'['5  '], '      O'['6'])))
```
...
```{r repmeas, echo=FALSE, fig.cap="Repeated Measures Experimental Design", fig.height=1, fig.width=3}
par(xaxs = 'i', yaxs = 'i', mar = c(1, 1, 1, 1))
plot(NA, xlim = c(1, 3), ylim = c(1, 2), axes = FALSE, ann = FALSE)
text(x = 2, y = 1.5, bquote(paste('O'['1'], ' O'['2'], ' O'['3'], ' O'['n'], '  X  ', 
                                   ' O'['n + 1'], ' O'['n + 2'], ' O'['n + 3'])))
```
...
1) Observational designs generally have higher ________ validity and lower ________ validity compared to experimental designs. Why?
