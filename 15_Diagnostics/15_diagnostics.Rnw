...
ds500 <- ds[1:500,c("glbcc_risk", "age", "education", "income", "ideol")]
...
abline(h=0)
lines(lowess(ds.small$income,rstudent(ols1)), lty=2, col="red")
plot(jitter(ds.small$ideol), jitter(rstudent(ols1)), main="Ideology")
abline(h=0)
lines(lowess(ds.small$ideol,rstudent(ols1)), lty=2, col="red")
plot(jitter(ols1$fitted), jitter(rstudent(ols1)), main="Fitted")
abline(h=0)
lines(lowess(ols1$fitted,rstudent(ols1)), lty=2, col="red")
dev.off()
@ 
\begin{figure}
        \centering
...
pdf("multregres.pdf")
plot(jitter(fitted(ols1)), jitter(residuals(ols1)), 
     xlab="Fitted", 
     ylab="Residuals")
abline(h=0, col="red")
dev.off()
...
<<echo=2,results="hide">>=
pdf("multresidhist.pdf")
hist(ols1$residuals)
dev.off()
@ 

<<echo=2:3,results="hide">>=
pdf("multresidden.pdf")
library(sm)
...
pdf("dfbetas.pdf")
par(mfrow=c(2,2))
plot(df.ols1[,2],ylab="dfbeta(Age)")
abline(h=c(2/sqrt(500),-2/sqrt(500)),lty=2,col="red")
plot(df.ols1[,3],ylab="dfbeta(Education)")
abline(h=c(2/sqrt(500),-2/sqrt(500)),lty=2,col="red")
plot(df.ols1[,4],ylab="dfbeta(Income)")
abline(h=c(2/sqrt(500),-2/sqrt(500)),lty=2,col="red")
plot(df.ols1[,5],ylab="dfbeta(Ideology)")
abline(h=c(2/sqrt(500),-2/sqrt(500)),lty=2,col="red")
dev.off()
@ 
...
<<>>=
cor(data.frame(na.omit(subset(ds, select=c("age","education","income","ideol")))))
@ 
