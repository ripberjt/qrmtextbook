...
knitr::include_graphics("spur.pdf")
```
...
knitr::include_graphics("partef.pdf")
```
...
Note that the estimated coefficient for ideology is \Sexpr{ols1$coef[2]}. To see how multiple regression removes the shared variance we first regress climate change risk on age and create an object `ols2.resids` of the residuals. 
